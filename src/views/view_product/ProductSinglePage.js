...
const ProductSinglePage = () => {
  ...
  const basketHandler = (product) => {
    ...
    addToBasket(basketDispatch, {...product, quantity: quantity, totalPrice, discountedPrice});
          ...
          <div className='product-s bg-white grid'>
            ...
            <div className='product-s-details py-5'>
              ...
              <div className='shop-btns'>
                <Link to = {route.LOGIN} className='buy-btn shop-btn fs-14'>Buy Now</Link>
                {
                  authData.isLoggedIn ? <button className='add-to-cart-btn shop-btn fs-14' onClick={() => basketHandler(singleProduct)}>Add to Cart</button> : <Link to = {route.LOGIN} className='add-to-cart-btn shop-btn fs-14'>Add to Cart</Link>
                }
              </div>
            </div>
          </div>
